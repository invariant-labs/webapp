...
export const LeftHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({ height, fill }) => (
  <>
    ...
    <path d="M0 4C0 1.79087 1.79086 0 4 0H36.2402V19.5893H4C1.79086 19.5893 0 17.7985 0 15.5893V4Z" fill={fill} />
...
export const RightHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({ height, fill }) => (
  <>
    ...
    <path d="M36.2402 4C36.2402 1.79087 34.4494 0 32.2402 0H-1.14441e-05V19.5893H32.2402C34.4494 19.5893 36.2402 17.7985 36.2402 15.5893V4Z" fill={fill}/>
    {/* <path d="M29 5V15" stroke="white" strokeOpacity="0.5"/>
    <path d="M32 5V15" stroke="white" strokeOpacity="0.5"/> */}
  </>
)

export const MaxHandle: React.FC<ISVGHandle> = ({ height, className, x, fill, textColor, isReversed = false }) => (
  <svg className={className} width="37" height={height} viewBox={`0 0 37 ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg" x={x}>
    {
      !isReversed
...
export const MinHandle: React.FC<ISVGHandle> = ({ height, className, x, fill, textColor, isReversed = false }) => (
  <svg className={className} width="37" height={height} viewBox={`0 0 37 ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg" x={x}>
    {
      !isReversed
        ? <LeftHandle height={height} fill={fill} />
